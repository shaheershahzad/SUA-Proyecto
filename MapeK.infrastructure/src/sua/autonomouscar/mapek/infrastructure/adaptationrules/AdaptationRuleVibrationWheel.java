...
public class AdaptationRuleVibrationWheel extends Thing implements IAdaptationRule{

	public AdaptationRuleVibrationWheel(BundleContext context, String id) {
		super(context, id);
	...
	public void executeAdaptation() {
		...
		System.out.println("Disabling SteeringWheel_HapticVibration");
