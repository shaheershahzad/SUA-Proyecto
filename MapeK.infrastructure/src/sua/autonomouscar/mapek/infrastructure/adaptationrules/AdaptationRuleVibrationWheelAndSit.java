...
public class AdaptationRuleVibrationWheelAndSit extends Thing implements IAdaptationRule{

	public AdaptationRuleVibrationWheelAndSit(BundleContext context, String id) {
		super(context, id);
	...
	public void executeAdaptation() {
		...
		System.out.println("Enabling SteeringWheel_HapticVibration and DriverSeat_HapticVibration");
