...
public class AdaptationRuleFallbackPlanEmergency extends Thing implements IAdaptationRule{

	public AdaptationRuleFallbackPlanEmergency(BundleContext context, String id) {
		super(context, id);
	...
	public void executeAdaptation() {
		...
		if(il3_DrivingService.isDriving()) {
			il3_DrivingService.setFallbackPlan("EmergencyFallbackPlan");		
		}
