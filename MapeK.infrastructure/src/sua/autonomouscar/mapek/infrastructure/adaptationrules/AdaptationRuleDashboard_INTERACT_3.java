...
public class AdaptationRuleDashboard_INTERACT_3 extends Thing implements IAdaptationRule{

	public AdaptationRuleDashboard_INTERACT_3(BundleContext context, String id) {
		super(context, id);
	...
	public void executeAdaptation() {
		...
		System.out.println("Enabling Dashboard Interaction");
		...
		if(drivingService.isDriving()) {
			...
			notificationService.removeInteractionMechanism("DashboardDisplay_VisualText");
